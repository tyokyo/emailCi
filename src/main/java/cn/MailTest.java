...
public static void main(String[] args) throws Exception {
	...
	String to = "qiang.zhang@sioeye.com";
	String cc = "qiang.zhang@sioeye.com";
	String subject = "test_12112";
	String attach =  "";
	String html =  "D:\\soft\\workspace\\workspace4\\jtlparser\\report\\result.html";

	MailInfo info = new MailInfo();
	info.setMailHost("smtphm.qiye.163.com");
	info.setMailPort("465");
	info.setUsername("qiang.zhang@sioeye.com");
	info.setPassword("zhangqiang@0307");
